        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: const EdgeInsets.symmetric(
              horizontal: SearchInputTextField.inputHorizontalPadding,
              vertical: SearchInputTextField.inputVerticalPadding,
            ),
            suffixIcon: const Padding(
              ...
              child: Icon(
                Icons.search,
                color: AppColors.primaryForest,
                size: SearchInputTextField.iconSize,
              ),
            ),
            suffixIconConstraints: const BoxConstraints(
              maxHeight: SearchInputTextField.iconSize,
              maxWidth: SearchInputTextField.iconSize + UIGaps.size16,
            ),
          ),
        ),
      ),
