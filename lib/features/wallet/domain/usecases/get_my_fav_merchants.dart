...
class GetMyFavMerchants implements UseCase<List<WalletItem>, NoParams> {
  GetMyFavMerchants({required WalletRepositories walletRepositories})
  ...
  Future<Either<Failure, List<WalletItem>>> call(NoParams params) =>
      _walletRepositories.getMyFavMerchants();
}
